...
Reads prompts from ./data/helm/prompt_mapping.txt, greedy-decodes 128 tokens per prompt,
sentence-splits the continuation, and writes ./data/helm/data/{model_name}/data.json
...
parser.add_argument("--prompt_file", type=str, default="./data/helm/prompt_mapping.txt")
...
out_dir = f"./data/helm/data/{model_name}"
